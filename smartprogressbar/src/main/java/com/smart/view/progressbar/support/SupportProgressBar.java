...
public class SupportProgressBar extends View{
    ...
    private static final String TAG = SupportProgressBar.class.getSimpleName();
    ...
    public SupportProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray t = context.obtainStyledAttributes(attrs, R.styleable.SupportProgressBar);
        int leftProgressBg;
        int rightProgressBg;
        try {
            leftProgressBg = t.getColor(R.styleable.SupportProgressBar_left_progress_bg,
                    getResources().getColor(R.color.bg_left_progress));
            mLeftValue = t.getInt(R.styleable.SupportProgressBar_left_progress_value, 0);
            rightProgressBg = t.getColor(R.styleable.SupportProgressBar_right_progress_bg,
                    getResources().getColor(R.color.bg_right_progress));
            mRightValue = t.getInt(R.styleable.SupportProgressBar_right_progress_value, 0);

            mProgressHeight = t.getDimensionPixelSize(R.styleable.SupportProgressBar_progress_height, 15);
            mLeftRightProgressSpacing = t.getInt(
                    R.styleable.SupportProgressBar_left_right_progress_spacing,
                    1);
            mProgressAnimDuration = t.getInt(R.styleable.SupportProgressBar_progress_anim_duration, 3000);
        } finally {
            t.recycle();
        }
    ...
    public int getmLeftRightProgressSpacing() {
        return mLeftRightProgressSpacing;
    }

    public void setmLeftRightProgressSpacing(int mLeftRightProgressSpacing) {
        this.mLeftRightProgressSpacing = mLeftRightProgressSpacing;
    }
